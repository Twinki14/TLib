...
struct ImGuiIO
{
    ...
    const char* IniFilename;                    // = "imgui.ini"    // PathExt to .ini file. Set NULL to disable automatic .ini loading/saving, if e.g. you want to manually load/save from memory.
    const char* LogFilename;                    // = "imgui_log.txt"// PathExt to .log file (default parameter to ImGui::LogToFile when no file is specified).
